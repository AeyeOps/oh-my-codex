...
const POSTURE_OVERLAYS: Record<AgentDefinition["posture"], string> = {
  "frontier-orchestrator": [
    ...
    "- Treat safe reversible work as already authorized after a direct request; do not ask for reconfirmation while ordinary routing, inspection, or verification remains.",
    "- Evidence or an explicit blocker is required before stopping.",
    "",
    "</posture_overlay>",
  ].join("\n"),
  "deep-worker": [
    ...
    "- Treat safe reversible work as already authorized after a direct request; do not ask for reconfirmation while ordinary implementation or verification remains.",
    "- Evidence or an explicit blocker is required before stopping.",
  ...
  "fast-lane": [
    ...
    "- Treat safe reversible work as already authorized after a direct request; do not ask for reconfirmation while ordinary triage or verification remains.",
    "- Evidence or an explicit blocker is required before stopping.",
    "",
    "</posture_overlay>",
  ].join("\n"),
