...
import { getVerificationInstructions, determineTaskSize, getFixLoopInstructions, hasStructuredVerificationEvidence, } from '../verifier.js';
...
`;
    ...
    it('returns false for unstructured summaries', () => {
        assert.equal(hasStructuredVerificationEvidence('Implemented fix and opened PR.'), false);
    });
