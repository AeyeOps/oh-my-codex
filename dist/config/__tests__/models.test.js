...
import { DEFAULT_FRONTIER_MODEL, DEFAULT_SPARK_MODEL, DEFAULT_TEAM_CHILD_MODEL, getEnvConfiguredStandardDefaultModel, getMainDefaultModel, getModelForMode, getSparkDefaultModel, getStandardDefaultModel, getTeamChildModel, getTeamLowComplexityModel, readConfiguredEnvOverrides, } from '../models.js';
describe('getModelForMode', () => {
    let tempDir;
    let originalCodexHome;
    let originalDefaultFrontierModel;
    let originalDefaultStandardModel;
    let originalDefaultSparkModel;
    let originalTeamChildModel;
    let originalSparkModel;
    beforeEach(async () => {
