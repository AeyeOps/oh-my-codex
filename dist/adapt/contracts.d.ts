export declare const ADAPT_SCHEMA_VERSION = "1.0";
export declare const ADAPT_TARGETS: readonly ["openclaw", "hermes"];
export type AdaptTarget = (typeof ADAPT_TARGETS)[number];
export declare const ADAPT_SUBCOMMANDS: readonly ["probe", "status", "init", "envelope", "doctor"];
export type AdaptSubcommand = (typeof ADAPT_SUBCOMMANDS)[number];
export type AdaptCapabilityOwnership = "omx-owned" | "shared-contract" | "target-observed";
...
export interface AdaptOpenClawMetadata {
    observedState: "configured" | "degraded" | "disabled" | "missing-config" | "invalid-config" | "not-configured";
