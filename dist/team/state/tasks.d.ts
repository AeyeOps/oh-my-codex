...
import type { TeamTask, TeamTaskV2, TaskReadiness, ClaimTaskResult, TransitionTaskResult, ReleaseTaskClaimResult, ReclaimTaskResult, TeamMonitorSnapshotState } from './types.js';
...
export declare function reclaimExpiredTaskClaim(taskId: string, deps: ReleaseDeps): Promise<ReclaimTaskResult>;
