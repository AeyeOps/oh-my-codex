...
import { startTeam, shutdownTeam, resolveWorkerLaunchArgsFromEnv, } from '../runtime.js';
...
`, { mode: 0o755 });
        ...
        let runtime = null;
        try {
            runtime = await withMockPromptModeCodexAllowed(() => withoutTeamWorkerEnv(() => startTeam('team-low-role-routing', 'low complexity routing handoff', 'executor', 2, [
    ...
    it('scaleUp preserves low-complexity assigned roles as outer runtime identities', async () => {
        ...
        try {
            ...
            const result = await scaleUp('low-role-scale', 1, 'executor', [{ subject: 'map files', description: 'map files', owner: 'worker-2', role: 'explore' }], cwd, { OMX_TEAM_SCALING_ENABLED: '1', OMX_TEAM_SKIP_READY_WAIT: '1' });
...
//# sourceMappingURL=worker-runtime-identity.test.js.map