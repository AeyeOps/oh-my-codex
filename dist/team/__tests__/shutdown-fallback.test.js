...
import { shutdownTeam, startTeam } from '../runtime.js';
...
`, { mode: 0o755 });
        ...
        try {
            runtime = await withMockPromptModeCodexAllowed(() => withoutTeamWorkerEnv(() => startTeam('team-shutdown-fallback-report', 'shutdown fallback merge report', 'executor', 1, [], repo, { worktreeMode: { enabled: true, detached: true, name: null } })));
            ...
            await writeFile(join(worktreePath, 'worker-note.txt'), 'from worker\n', 'utf-8');
            ...
            const reportPath = join(preservedWorktreePath, '.omx', 'diff.md');
...
//# sourceMappingURL=shutdown-fallback.test.js.map