...
export declare function readTeamPaneStatus(config: Awaited<ReturnType<typeof readTeamConfig>>, cwd?: string, snapshot?: Pick<TeamSnapshot, 'teamName' | 'deadWorkers' | 'nonReportingWorkers' | 'workers' | 'tasks'>, tailLines?: number): Promise<{
