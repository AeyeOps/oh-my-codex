...
import { buildFullChangelogLine, generateReleaseBody, renderContributorsSection, verifyCompareRange, } from '../generate-release-body.js';
...
describe('generate-release-body', () => {
    ...
    it('rejects missing or inverted compare refs before rendering a compare link', async () => {
        ...
        try {
            ...
            assert.throws(() => verifyCompareRange(root, 'v0.13.1', 'v9.99.9'), /unable to verify previous tag ref for release compare: v9\.99\.9/);
            assert.throws(() => verifyCompareRange(root, 'v0.13.0', 'v0.13.1'), /invalid release compare range: v0\.13\.1 is not an ancestor of v0\.13\.0/);
            await writeFile(join(root, 'RELEASE_BODY.md'), TEMPLATE);
            await assert.rejects(generateReleaseBody({
                cwd: root,
                templatePath: 'RELEASE_BODY.md',
                outPath: 'RELEASE_BODY.generated.md',
                currentTag: 'v0.13.1',
...
`);
    ...
    it('renders contributor and changelog helpers for edge cases', () => {
        ...
        assert.equal(buildFullChangelogLine('example/oh-my-codex', 'v0.13.1', 'v0.13.0'), '**Full Changelog**: [`v0.13.0...v0.13.1`](https://github.com/example/oh-my-codex/compare/v0.13.0...v0.13.1)');
        assert.equal(buildFullChangelogLine('example/oh-my-codex', 'v0.1.0'), '**Full Changelog**: [`v0.1.0`](https://github.com/example/oh-my-codex/releases/tag/v0.1.0)');
    });
});
//# sourceMappingURL=generate-release-body.test.js.map