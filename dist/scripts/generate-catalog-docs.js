...
function main() {
    ...
    if (CHECK_ONLY) {
        ...
        const generatedCounts = generatedRaw.counts;
        ...
        assertDeepEqual('catalog_generated_drift:content_mismatch', normalizePublicContract(generatedRaw), normalizePublicContract(publicContract));
...
main();
//# sourceMappingURL=generate-catalog-docs.js.map