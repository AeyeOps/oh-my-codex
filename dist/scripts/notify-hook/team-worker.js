...
import { classifyLeaderActionState, resolveAllWorkersIdleIntent, resolveWorkerIdleIntent, } from './orchestration-intent.js';
...
async function emitLeaderPaneMissingDeferred({ stateDir, logsDir, teamName, workerName, tmuxSession, leaderPaneId, reason = 'leader_pane_missing_no_injection', paneCurrentCommand = '', sourceType = 'unknown', orchestrationIntent = '', }) {
