...
function isSafeStateFileName(fileName) {
...
export async function readCurrentSessionId(baseStateDir) {
...
export async function resolveScopedStateDir(baseStateDir, explicitSessionId) {
...
export async function getScopedStateDirsForCurrentSession(baseStateDir, explicitSessionId, options = {}) {
...
export async function getScopedStatePath(baseStateDir, fileName, explicitSessionId) {
...
export async function readScopedJsonIfExists(baseStateDir, fileName, explicitSessionId, fallback, options = {}) {
    if (!isSafeStateFileName(fileName)) {
        throw new Error(`unsafe state file name: ${fileName}`);
    }
    const candidateDirs = await getScopedStateDirsForCurrentSession(baseStateDir, explicitSessionId, options);
...
export async function writeScopedJson(baseStateDir, fileName, explicitSessionId, value) {
