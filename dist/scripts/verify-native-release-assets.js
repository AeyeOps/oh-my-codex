...
for (const asset of manifest.assets) {
    ...
    if (!archivePath)
        throw new Error(`missing archive ${asset.archive}`);
    ...
    if (list.status !== 0)
        throw new Error(`unable to inspect archive ${asset.archive}: ${list.stderr || list.stdout}`);
...
//# sourceMappingURL=verify-native-release-assets.js.map