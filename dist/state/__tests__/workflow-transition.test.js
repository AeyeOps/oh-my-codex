...
import { buildWorkflowTransitionMessage, buildWorkflowTransitionError, evaluateWorkflowTransition, } from '../workflow-transition.js';
describe('workflow transition rules', () => {
    ...
    it('formats transition audit messages', () => {
        assert.equal(buildWorkflowTransitionMessage('ralplan', 'ralph'), 'mode transiting: ralplan -> ralph');
    });
});
//# sourceMappingURL=workflow-transition.test.js.map