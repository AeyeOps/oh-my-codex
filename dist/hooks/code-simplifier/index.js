 ...
 */
export function readOmxConfig(configDir) {
 ...
 */
export function isCodeSimplifierEnabled(configDir) {
...
export function buildSimplifierMessage(files) {
    ...
    return (`[CODE SIMPLIFIER] Recently modified files detected. Delegate to the ` +
 ...
 */
export function processCodeSimplifier(cwd, stateDir, configDir) {
