...
import { isAlreadyTriggered, writeTriggerMarker, clearTriggerMarker, buildSimplifierMessage, getModifiedFiles, processCodeSimplifier, TRIGGER_MARKER_FILENAME, } from '../index.js';
function makeTmpDir() {
...
function writeEnabledCodeSimplifierConfig(homeDir) {
    const configDir = join(homeDir, '.omx');
    mkdirSync(configDir, { recursive: true });
    writeFileSync(join(configDir, 'config.json'), JSON.stringify({ codeSimplifier: { enabled: true, maxFiles: 5 } }, null, 2), 'utf-8');
}
