...
export type HookEventName = 'session-start' | 'stop' | 'session-end' | 'session-idle' | 'turn-complete' | 'blocked' | 'run.heartbeat' | 'run.blocked_on_user' | 'run.blocked_on_system' | 'finished' | 'failed' | 'worker.assigned' | 'worker.stalled' | 'worker.recovered' | 'retry-needed' | 'pr-created' | 'test-started' | 'test-finished' | 'test-failed' | 'handoff-needed' | 'needs-input' | 'pre-tool-use' | 'post-tool-use' | (string & {});
...
export type HookPluginDispatchStatus = 'ok' | 'timeout' | 'error' | 'invalid_export' | 'runner_error' | 'spawn_failed' | 'runner_missing' | 'skipped_team_worker' | 'skipped';
