...
const RESEARCHER_EXTERNAL_SIGNALS = [
...
const IMPLEMENTATION_ACTION_SIGNALS = [
...
function isQuestionOrExplanation(normalized, wordCount) {
...
function hasAnchoredEditPattern(normalized) {
...
export function triagePrompt(prompt) {
    ...
    if ((!hasLocalResearchAnchor || hasExternalRouteOverride) &&
        !hasImplementationAction &&
        hasResearchLookupVerb &&
        (hasExternalResearchSignal ||
