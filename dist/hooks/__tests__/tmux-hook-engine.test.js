...
import { DEFAULT_ALLOWED_MODES, DEFAULT_MARKER, normalizeTmuxCapture, normalizeTmuxHookConfig, pickActiveMode, paneHasActiveTask, paneIsBootstrapping, paneShowsCodexViewport, paneLooksReady, evaluateInjectionGuards, buildSendKeysArgv, buildPaneCurrentCommandArgv, isPaneRunningShell, resolveCodexPane, } from '../../scripts/tmux-hook-engine.js';
...
describe('buildPaneCurrentCommandArgv', () => {
    it('builds argv to query pane_current_command', () => {
        assert.deepEqual(buildPaneCurrentCommandArgv('%5'), ['display-message', '-p', '-t', '%5', '#{pane_current_command}']);
    });
});
...
//# sourceMappingURL=tmux-hook-engine.test.js.map