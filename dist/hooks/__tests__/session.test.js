...
import { resetSessionMetrics, reconcileNativeSessionStart, writeSessionStart, writeSessionEnd, readSessionState, readUsableSessionState, isSessionStale, } from '../session.js';
...
describe('session lifecycle manager', () => {
    it('resets session metrics files with zeroed counters', async () => {
        ...
        try {
            ...
            const hud = JSON.parse(await readFile(hudPath, 'utf-8'));
