...
export declare const AUTORESEARCH_DEEP_INTERVIEW_RESULT_KIND = "omx.autoresearch.deep-interview/v1";
...
export declare function listAutoresearchDeepInterviewDraftPaths(repoRoot: string): Promise<string[]>;
