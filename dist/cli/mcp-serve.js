import { OMX_FIRST_PARTY_MCP_PLUGIN_TARGETS, OMX_PLUGIN_MCP_SERVE_SUBCOMMAND, } from "../config/omx-first-party-mcp.js";
...
const MCP_SERVE_TARGET_ALIASES = {
...
export function normalizeOmxMcpServeTarget(rawTarget) {
...
export async function mcpServeCommand(args, options = {}) {
