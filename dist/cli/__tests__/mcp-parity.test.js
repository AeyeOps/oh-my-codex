...
describe("mcpParityCommand", () => {
    it("supports state write/read parity via CLI", async () => {
        ...
        try {
            ...
            const writeResult = JSON.parse(logs.pop() || "{}");
            ...
            const readResult = JSON.parse(logs.pop() || "{}");
    ...
    it("supports notepad and project-memory parity via CLI", async () => {
        ...
        try {
            ...
            const notepadWrite = JSON.parse(logs.pop() || "{}");
            ...
            const notepadRead = JSON.parse(logs.pop() || "{}");
            ...
            const addNote = JSON.parse(logs.pop() || "{}");
            ...
            const memoryRead = JSON.parse(logs.pop() || "{}");
    ...
    it("supports trace summary parity via CLI", async () => {
        ...
        try {
            ...
            await writeFile(join(logsDir, "turns-2026-04-08.jsonl"), `${JSON.stringify({ timestamp: "2026-04-08T13:00:00.000Z", type: "assistant" })}\n`);
            ...
            const summary = JSON.parse(logs.pop() || "{}");
    ...
    it("supports wiki parity via CLI", async () => {
        ...
        try {
            ...
            const addResult = JSON.parse(logs.pop() || "{}");
            ...
            const queryResult = JSON.parse(logs.pop() || "[]");
...
//# sourceMappingURL=mcp-parity.test.js.map