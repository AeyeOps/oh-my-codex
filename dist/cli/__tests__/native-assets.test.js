...
import { hydrateNativeBinary, inferNativeAssetLibc, resolveCachedNativeBinaryCandidatePaths, resolveCachedNativeBinaryPath, resolveNativeReleaseAssetCandidates, resolveNativeReleaseBaseUrl, } from '../native-assets.js';
...
describe('native asset helpers', () => {
    ...
    it('prefers musl cache paths before glibc and legacy Linux cache paths', () => {
        assert.deepEqual(resolveCachedNativeBinaryCandidatePaths('omx-sparkshell', '0.8.15', 'linux', 'x64', {
    ...
    it('orders manifest assets musl-first for Linux hydration', () => {
        ...
        assert.deepEqual(ordered.map((asset) => asset.archive), [
...
//# sourceMappingURL=native-assets.test.js.map