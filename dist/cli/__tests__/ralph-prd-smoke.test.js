...
async function installFakeCodex(fakeBin, launchLog) {
...
function buildEnv(home, fakeBin) {
    return {
        HOME: home,
...
async function writePrdJson(cwd, payload) {
...
//# sourceMappingURL=ralph-prd-smoke.test.js.map