...
import { SKILL_ACTIVE_STATE_MODE, readSkillActiveState, syncCanonicalSkillStateForMode, writeSkillActiveStateCopies, } from "../state/skill-active.js";
...
export async function handleStateToolCall(request) {
    ...
    try {
        explicitSessionId = validateSessionId(args?.session_id);
    }
    catch (error) {
        return {
            content: [
            ...
            case "state_write": {
                ...
                await withStateWriteLock(path, async () => {
                    ...
                    const explicitLifecycleOutcome = Object.prototype.hasOwnProperty.call(fields, "lifecycle_outcome")
                        || (customState != null
                            && Object.prototype.hasOwnProperty.call(customState, "lifecycle_outcome"));
                    ...
                    const explicitTerminalOutcome = Object.prototype.hasOwnProperty.call(fields, "terminal_outcome")
                        || (customState != null
                            && Object.prototype.hasOwnProperty.call(customState, "terminal_outcome"));
