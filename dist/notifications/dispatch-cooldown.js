 ...
 */
export function getDispatchNotificationCooldownSeconds() {
 ...
 */
export function shouldSendDispatchNotification(stateDir, sessionId) {
 ...
 */
export function recordDispatchNotificationSent(stateDir, sessionId) {
    const cooldownPath = getCooldownStatePath(stateDir, sessionId);
    try {
...
//# sourceMappingURL=dispatch-cooldown.js.map