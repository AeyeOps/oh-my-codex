 ...
 */
export declare function computeTemplateVariables(payload: FullNotificationPayload): Record<string, string>;
/**
 ...
 */
export declare function interpolateTemplate(template: string, payload: FullNotificationPayload): string;
/**
