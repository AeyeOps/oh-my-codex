...
const ENV_KEYS = ['CODEX_HOME', 'TMUX', 'TMUX_PANE', 'PATH'];
const originalFetch = globalThis.fetch;
function writeNotificationConfig(codexHome) {
...
function writeFakeTmux(fakeBinDir, output) {
...
describe('notifyLifecycle tmux tail auto-capture', () => {
    ...
    it('does not auto-capture historical tmux tail for terminal notifications', async () => {
        ...
        for (const eventName of ['session-end', 'session-stop']) {
            let capturedBody = '';
