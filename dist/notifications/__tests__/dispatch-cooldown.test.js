...
import { getDispatchNotificationCooldownSeconds, shouldSendDispatchNotification, recordDispatchNotificationSent, } from '../dispatch-cooldown.js';
...
describe('recordDispatchNotificationSent', () => {
    ...
    it('writes a cooldown file with lastSentAt timestamp', () => {
        ...
        const content = JSON.parse(readFileSync(join(stateDir, 'dispatch-notif-cooldown.json'), 'utf-8'));
...
//# sourceMappingURL=dispatch-cooldown.test.js.map