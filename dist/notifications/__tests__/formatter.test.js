...
import { formatSessionIdle, formatSessionStart, formatSessionEnd, formatSessionStop, formatAskUserQuestion, formatNotification, parseTmuxTail, } from '../formatter.js';
const basePayload = {
    event: 'session-idle',
...
describe('parseTmuxTail', () => {
    ...
    it('keeps wrapped Korean continuation lines in the same block', () => {
        ...
        assert.ok(result.indexOf('block 10: 2. 아예 ~/.codex/.omx-config.json에서 조절 가능하') <
