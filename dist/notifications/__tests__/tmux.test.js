...
import { getCurrentTmuxSession, getCurrentTmuxPaneId, formatTmuxInfo, getTeamTmuxSessions, captureTmuxPane, captureTmuxPaneWithLiveness, sanitizeTmuxAlertText, } from '../tmux.js';
...
describe('getTeamTmuxSessions - session matching', () => {
    ...
    function makeFakeTmux(sessions) {
