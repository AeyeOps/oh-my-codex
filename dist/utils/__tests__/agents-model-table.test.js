...
import { buildAgentsModelTable, OMX_MODELS_END_MARKER, OMX_MODELS_START_MARKER, resolveAgentsModelTableContext, upsertAgentsModelTable, } from '../agents-model-table.js';
...
describe('agents model table', () => {
    ...
    it('replaces existing marker-bounded content and inserts the block after team_model_resolution when missing', () => {
        ...
        assert.match(inserted, /<\/team_model_resolution>\n\n<!-- OMX:MODELS:START -->[\s\S]*<!-- OMX:MODELS:END -->\n\n---/);
    });
});
//# sourceMappingURL=agents-model-table.test.js.map