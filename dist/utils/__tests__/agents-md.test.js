...
import { addGeneratedAgentsMarker, hasOmxManagedAgentsSections, isOmxGeneratedAgentsMd, OMX_GENERATED_AGENTS_MARKER, } from '../agents-md.js';
describe('agents-md helpers', () => {
    it('inserts the generated marker after the autonomy directive block', () => {
        ...
        assert.match(result, /<!-- END AUTONOMY DIRECTIVE -->\n<!-- omx:generated:agents-md -->\n# oh-my-codex - Intelligent Multi-Agent Orchestration/);
    });
